...
<head>
<meta charset="UTF-8">
<title>NewsUpdateForm.jsp</title>
...
<div class="container">
	<div class="col-md-2" align="left">
		<div class="panel-heading">
			 ...
			 <h4 class="panel-title" align="center">소식 게시글 수정</h4>
			<!-- <h4 class="panel-title" align="center">자유게시판</h4> -->
			<hr>
		</div>
	</div>
		
	  <form action="newsupdate.action" method="post" name="NewsUpdateForm" id="NewsUpdateForm" class="form-horizontal">	
	  
	<div class="container">
		<table class="table" style="text-align: center;">
			<c:forEach var="v" items="${newsUpdate}" varStatus="status">
			<tr>
				<td>제목</td>
				<td>
