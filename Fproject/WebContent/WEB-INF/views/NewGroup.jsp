...
<div class="container">
	...
	<div>
		<div class="left" >
			<button type="button" class="btn btn-default">테마별 > 신규모임</button>
		</div>
		<div class="right" align="right"> 
			<a href="theme.action">인기모임</a> | <a style="font-weight: bold;">신규모임</a> | <a href="hothost.action">인기호스트</a> 
	...
	<div class="row">
		...
		<div class="col-sm-6 col-md-4">
			<div class="thumbnail">
				<img src="uploads/${NewGroupAll.ngPic }" alt="썸네일" class="img-responsive" style="width: 100%;"
					onclick="location.href='groupdetail.action?ngCode=${NewGroupAll.ngCode}'">
			<div class="caption">
			<div>
			...
			<div>
				...
				<div>
					<div class="name" onclick="location.href='groupdetail.action?ngCode=${NewGroupAll.ngCode}'">
