...
<div class="container">
	...
	<div>
		<div class="left">
			<button type="button" class="btn btn-default" style="font-weight: bold;">맛집 > 카페</button>
		</div>
		<div class="right" align="right">
			<a href="restaurant.action">식당</a> | <a style="font-weight: bold;">카페</a>
		</div>
	</div>
	...
	<div align="right">
		...
		<label class="check-inline">
		  	<input type="checkbox" name="inlineRadioOptions" id="inlineCheck2" checked="checked" onclick="location='cafe.action'"value="참여모임">참여 가능한 모임만 볼래요!
		</label>
	</div>
	    ...
	    <div class="btn-group" role="group">
		   <c:choose>
		    ...
		    <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
		      <a class="dropdown-item" onclick="location='cafeable.action?ordercheck=1'" style="cursor:pointer;">최신순</a>
		      <a class="dropdown-item" onclick="location='cafeable.action?ordercheck=2'" style="cursor:pointer;">인기순</a>
		      <a class="dropdown-item" onclick="location='cafeable.action?ordercheck=3'" style="cursor:pointer;">별점순</a>
		    </div>
	  	</div>
  	</div>
  	<br><br><br>
	...
	<div class="row">
		<c:forEach var="FoodGroup" items="${CafeAbleGroupList}">
