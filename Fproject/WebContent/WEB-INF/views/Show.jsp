...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-6 col-md-4" onclick="location.href='groupdetail.action?ngCode=${ShowGroup.ngCode}'">
			<div class="thumbnail">
			...
			<div>
				...
				<h6 style="text-align: right; font-size: 10px;">"${ShowGroup.memName }"</h6>
			</div>
