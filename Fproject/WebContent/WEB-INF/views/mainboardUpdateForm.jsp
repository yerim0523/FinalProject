...
<script type="text/javascript">
	...
	function formCheck()
	{
		var f = document.mainboardUpdateForm;
...
<div class="container">
	...
	<form action="mainboardupdate.action" method="post" name="mainboardUpdateForm" id="mainboardUpdateForm" class="form-horizontal">
	<div class="container">
		<table class="table" style="text-align: center;">
			<c:forEach var="v" items="${mainboardUpdate }" varStatus="status">
			<tr>
				
				<td>제목</td>
				<td>
					<input type="text" class="form-control" id="boardTitle"  placeholder="제목 입력(4-100)" name="boardTitle" maxlength="100"
							required="required" pattern=".{4,100}" value="${v.boardTitle }">
