...
<div class="container">
	...
	<div align="right">
		<label class="check-inline">
			<input type="checkbox" name="inlineRadioOptions" id="inlineCheck1" checked="checked" onclick="location='cafe.action'" value="종료모임">종료 모임도 볼래요!
		</label>
		<label class="check-inline">
	    ...
	    <div class="btn-group" role="group">
		   <c:choose>
		    ...
		    <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
		      <a class="dropdown-item" onclick="location='cafeclose.action?ordercheck=1'" style="cursor:pointer;">최신순</a>
		      <a class="dropdown-item" onclick="location='cafeclose.action?ordercheck=2'" style="cursor:pointer;">인기순</a>
		      <a class="dropdown-item" onclick="location='cafeclose.action?ordercheck=3'" style="cursor:pointer;">별점순</a>
		    </div>
	  	</div>
  	</div>
  	<br><br><br>
	...
	<div class="row">
		<c:forEach var="FoodGroup" items="${CafeCloseGroupList}">
